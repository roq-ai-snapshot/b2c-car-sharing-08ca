  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to B2C Car Sharing - Empowering individual customers to conveniently book nearby cars, managed seamlessly by our dedicated operations staff through centralized dashboards."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to B2C Car Sharing - Empowering individual customers to conveniently book nearby cars, managed seamlessly by our dedicated operations staff through centralized dashboards.`}
            </Text>
            <Box
